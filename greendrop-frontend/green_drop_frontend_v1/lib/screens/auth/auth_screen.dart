...
class _AuthScreenState extends State<AuthScreen> {
  ...
  void _showPhoneOtpModal() {
    ...
    final otpDigit1 = TextEditingController(text: '1');
    final otpDigit2 = TextEditingController(text: '2');
    final otpDigit3 = TextEditingController(text: '3');
    final otpDigit4 = TextEditingController(text: '4');
    final otpDigit5 = TextEditingController(text: '5');
    final otpDigit6 = TextEditingController(text: '6');
      ...
      builder: (context) => StatefulBuilder(
        builder: (modalContext, setModalState) {
          ...
          Future<void> sendOtp() async {
            ...
            final fullPhone = '$selectedCountryCode $rawPhone';

            try {
              final res = await ApiService.post('/auth/send-otp', {'phoneNumber': fullPhone});
              final data = jsonDecode(res.body);
                ...
                SnackBar(
                  content: Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(data['message'] ?? 'OTP sent successfully to $fullPhone (Demo OTP: 123456)'),
                      ),
                    ],
                  ),
                  backgroundColor: Colors.green.shade800,
          ...
          Future<void> verifyOtp() async {
            final otpCode = '${otpDigit1.text}${otpDigit2.text}${otpDigit3.text}${otpDigit4.text}${otpDigit5.text}${otpDigit6.text}';
            if (otpCode.length < 6) {
              _showErrorSnackBar('Please enter the full 6-digit OTP code');
              return;
            }
                  ...
                  SnackBar(
                    content: const Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text('✓ Phone Number Verified Successfully! Signed in.'),
                      ],
                    ),
                    backgroundColor: Colors.green.shade800,
                  ),
            ...
            // Offline / Fallback Demo login verification
            if (!modalContext.mounted || !mounted) return;
            countdownTimer?.cancel();
            Navigator.pop(modalContext);
              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          isOtpSent
                              ? 'Enter the 6-digit security OTP code sent to your phone'
                              : 'Authenticated login via SMS mobile verification',
                          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
                        ),
                      ],
                    ),
                ...
                if (!isOtpSent) ...[
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            onChanged: (val) {
                              if (val != null) setModalState(() => selectedCountryCode = val);
                            },
                          ),
                        ),
                      ),
                  ...
                  ElevatedButton(
                    ...
                    child: isVerifying
                        ...
                        : const Row(
                            ...
                            children: [
                              Text('Send 6-Digit OTP Code', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                              SizedBox(width: 8),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'Sent to $selectedCountryCode ${phoneController.text.trim()}',
                        style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w600, color: Colors.grey.shade800),
                      ),
                      GestureDetector(
                        onTap: () => setModalState(() => isOtpSent = false),
                        child: Text(
                          'Edit Number',
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: resendCountdown == 0 ? sendOtp : null,
                        child: Text(
                          'Resend OTP',
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: resendCountdown == 0 ? Colors.green.shade800 : Colors.grey,
                          ),
                        ),
                      ),
                    ],
                    ...
                    child: isVerifying
                        ...
                        : const Row(
                            ...
                            children: [
                              Icon(Icons.verified_user_rounded, color: Colors.white, size: 18),
                              SizedBox(width: 8),
                              Text('Verify OTP & Complete Sign In', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                            ],
                          ),
                  ),
                ],
